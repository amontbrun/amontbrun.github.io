...
<script>
    ...
    export default {
        ...
        data() { 
            return {
                misdatos: {
                    name: 'Andres E.',
                    lastname: 'Montbrun F.',
                    address: 'Calle Paseo El Bosque Qta Montflor',
                    phone: '+58(412)2370080',
                    email: 'amontbrun@yahoo.com',
                    description: 'I am  Rookie Developer ;)',
                    facebook: 'https://facebook.com/amontbrun',
                    twitter: 'https://twitter.com/amontbrun',
                    linkedin: 'https://www.linkedin.com/in/andres-montbrun-480bb12/',
                    github: 'https://github.com/amontbrun'
                },
                experiences: [
                    { 
                        job:'Especialista Ventas Managed Services', 
                        company: 'Hewlet Packard Corporation', 
                     ...
                     { 
                        job:'Outsourcing Sales manager for Latin America', 
                        company: 'Hewlet Packard Corporation', 
                        description: 'Bring to the table win-win survival strategies to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined cloud solution. User generated content in real-time will have multiple touchpoints for offshoring.', 
                        date: 'June 2011 - March 2013' 
                    },
                     { 
                        job:'IOT Business Development', 
                        company: 'Automatización Group', 
                        description: 'Develope Business Strategy for IOT Market, Ecommerce B2B and B2C for LAC, IOT Software and Device Development', 
                        date: 'June 2011 - March 2013' 
                    },
                ...
                education: [
                    { 
                        Title:'Especialista Ventas Managed Services', 
                        Instutite: 'Hewlet Packard Corporation', 
                        description: 'Bring to the table win-win survival strategies to ensure proactive domination. At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined cloud solution. User generated content in real-time will have multiple touchpoints for offshoring.', 
                        date: 'March 2013 - Present' 
                    },
                     { 
        ...
        methods: {
            getMisdatos(){
                axios.get('http://172.31.38.32:8000/api/about/3').then(response => {
